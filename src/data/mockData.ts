...
export const monitorDevices: MonitorDevice[] = [
  ...
  },
  {
    ...
    lastUpdate: '2025-07-15 14:31:00',
    resolution: '4K',
    coverage: 520,
    height: 16,
    angle: 125,
  ...
  },
  {
    ...
    lastUpdate: '2025-07-15 11:45:00',
    battery: 15,
    signal: 45
  },
  // 无人机设备
  ...
  },
  {
    ...
    lastUpdate: '2025-07-15 13:15:00',
    battery: 5,
    coverage: 2000,
    height: 100,
    signal: 0
...
export const flameDetections: FlameDetection[] = [
  ...
  },
  {
    ...
    windDirection: '西南风',
    windSpeed: 4.5,
    lastUpdate: '2025-07-15 14:18:45',
    coordinates: { latitude: 35.3867, longitude: 116.9867 },
    status: 'spreading',
    estimatedArea: 420
  },
  {
    ...
    windDirection: '北风',
    windSpeed: 2.8,
    lastUpdate: '2025-07-15 14:12:10',
    coordinates: { latitude: 35.4053, longitude: 116.9734 },
    status: 'controlled',
    estimatedArea: 95
  },
  {
    ...
    windDirection: '东风',
    windSpeed: 5.2,
    lastUpdate: '2025-07-15 14:05:25',
    coordinates: { latitude: 35.4012, longitude: 116.9734 },
    status: 'spreading',
    estimatedArea: 650
  },
  {
    ...
    windDirection: '南风',
    windSpeed: 1.5,
    lastUpdate: '2025-07-15 13:58:40',
    coordinates: { latitude: 35.4089, longitude: 116.9756 },
    status: 'extinguished',
    estimatedArea: 0
  },
  {
    ...
    windDirection: '西北风',
    windSpeed: 3.8,
    lastUpdate: '2025-07-15 13:52:15',
    coordinates: { latitude: 35.3845, longitude: 116.9823 },
    status: 'detected',
    estimatedArea: 320
  }
...
export const wechatAlerts: WeChatAlert[] = [
  {
    ...
    recipientName: '张三',
    message: '🔥紧急火焰告警\n设备：红外热成像-02\n位置：邹城市太平镇森林边缘\n状况：检测到大面积火焰，火势正在蔓延\n时间：2025-07-15 14:18:45\n请立即处理！',
    timestamp: '2025-07-15 14:18:48',
    status: 'delivered',
  ...
  },
  {
    ...
    wechatId: 'wx_lisi',
    recipientName: '李四',
    message: '💨烟雾浓度异常\n设备：红外热成像-02\n位置：邹城市太平镇森林边缘\n状况：烟雾浓度达到92%\n时间：2025-07-15 14:05:00\n请立即处理！',
    timestamp: '2025-07-15 14:05:03',
    status: 'delivered',
    messageType: 'template'
  },
  {
    ...
    wechatId: 'wx_wangwu',
    recipientName: '王五',
    message: '🔥火焰检测告警\n设备：邹城中心区监控点-05\n位置：邹城市钢山街道农田中心\n状况：发现大面积火焰，火势较大\n时间：2025-07-15 14:05:25\n请立即处理！',
    timestamp: '2025-07-15 14:05:28',
    status: 'sent',
    messageType: 'card'
  }
];
...
export const users: User[] = [
  ...
  },
  {
    ...
    department: '监控中心',
    phone: '13800138002',
    email: 'zhangsan@zoucheng.gov.cn',
    lastLogin: '2025-07-15 14:25:00',
    status: 'active',
  ...
  },
  {
    ...
    department: '监控中心',
    phone: '13800138003',
    email: 'lisi@zoucheng.gov.cn',
    lastLogin: '2025-07-15 14:20:00',
    status: 'active',
    permissions: ['monitor', 'alert', 'inspection']
  },
  {
    ...
    department: '农业农村局',
    phone: '13800138004',
    email: 'wangwu@zoucheng.gov.cn',
    lastLogin: '2025-07-15 14:15:00',
    status: 'active',
    permissions: ['view']
  }
];
